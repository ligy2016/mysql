...
/*Table structure for table `tcahissub3balance` */

DROP TABLE IF EXISTS `tcahissub3balance`;

CREATE TABLE `tcahissub3balance` (
  `fs_fuacct` varchar(18) NOT NULL,
  `fi_sub2fuacct` int(11) NOT NULL,
  `fi_sub3fuacct` int(11) NOT NULL,
  `Fd_Balance` decimal(38,4) NOT NULL,
  `Fd_OpenBal` decimal(38,4) NOT NULL,
  `Fd_CloseBal` decimal(38,4) NOT NULL,
  `Fs_acdate` char(8) NOT NULL,
  `Fs_settdate` char(8) NOT NULL,
  PRIMARY KEY (`Fs_settdate`,`fs_fuacct`,`fi_sub2fuacct`,`fi_sub3fuacct`)
