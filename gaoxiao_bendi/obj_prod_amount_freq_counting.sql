...
/*!50003 DROP PROCEDURE IF EXISTS  `prod_amount_freq_counting` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `prod_amount_freq_counting`(  contestcode VARCHAR (32),  OUT ret INT)
LABEL_PROC :
BEGIN
...
set t1.Fs_dailytradenum =  t3.fi_todayfreq,
	...
	where  ( t1.fs_fuacct = t3.fs_fuacct and t2.fs_fuacct = t3.fs_fuacct ) and t3.Fs_raceid =contestcode;
  COMMIT;
END */$$
DELIMITER ;
