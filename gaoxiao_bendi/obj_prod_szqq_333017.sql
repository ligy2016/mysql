...
/* Procedure structure for procedure `prod_szqq_333017` */

/*!50003 DROP PROCEDURE IF EXISTS  `prod_szqq_333017` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `prod_szqq_333017`(op_branch_no	varchar(5),
