...
/*Table structure for table `trqhisoptunentrust00` */

DROP TABLE IF EXISTS `trqhisoptunentrust00`;

CREATE TABLE `trqhisoptunentrust00` (
  ...
  KEY `idx_trqhisoptunentrust00_1` (`Fs_branchno`) USING BTREE,
  KEY `idx_trqhisoptunentrust00_2` (`Fi_Orgentrustno`) USING BTREE
