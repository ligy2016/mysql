...
/*!50003 DROP PROCEDURE IF EXISTS  `prod_ccnt_insert_list` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `prod_ccnt_insert_list`(OUT `res` char(1), INOUT `acno` int, IN `type1` char(1), IN `ctid` int, IN `fuacct` varchar(18), IN `sub2fuacct` int, IN `sub3fuacct` int,IN `amttype` varchar(3), IN `amtocctype` varchar(8), IN `dric` int, IN `amt` decimal(19,3), IN `trdtype` varchar(32), IN `trdorderno` varchar(32))
BEGIN
##名称
