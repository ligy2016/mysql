...
/*!50003 CREATE DEFINER=`qlqqmn`@`%` PROCEDURE `prod_ct_close_table_2_his`(IN `table_name` varchar(512), IN `table_name_his` varchar(512), IN `mkdate` char(8), IN `delflag` int)
BEGIN
##名称
