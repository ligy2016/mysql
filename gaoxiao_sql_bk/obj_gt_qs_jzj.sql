...
/* Procedure structure for procedure `gt_qs_jzj` */

/*!50003 DROP PROCEDURE IF EXISTS  `gt_qs_jzj` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `gt_qs_jzj`(IN `fuaccttype` int,IN `settdate` char(8))
LABEL_PROC:
BEGIN
	#按照资金类型结资金（建议：感觉一个资金类型一套资金表或者一个柜台一套资金表合理一些）
	#fuaccttype 资金类型,settdate 清算日期
