...
/* Procedure structure for procedure `prod_每日资产统计` */

/*!50003 DROP PROCEDURE IF EXISTS  `prod_每日资产统计` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `prod_每日资产统计`(
...
BEGIN 
	ROLLBACK;
	SET ret = 1 ;
	SET msg = CONCAT(	  'error ',	  'prod_每日资产统计'	,LINE) ;	
