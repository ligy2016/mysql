...
/* Procedure structure for procedure `gp_zdscsp` */

/*!50003 DROP PROCEDURE IF EXISTS  `gp_zdscsp` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `gp_zdscsp`(IN `src` int,IN `marketcode` varchar(32))
LABEL_PROC:
BEGIN
#指定市场收盘
#marketcode 市场id
#获取当前状态
	...
	END IF;
#1撤单
CALL prod_szqq_gprj(marketcode);
