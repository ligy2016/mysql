...
/*Table structure for table `tgoodsmanagement` */

DROP TABLE IF EXISTS `tgoodsmanagement`;

CREATE TABLE `tgoodsmanagement` (
  ...
  PRIMARY KEY (`Fs_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='比赛商品管理记录';
