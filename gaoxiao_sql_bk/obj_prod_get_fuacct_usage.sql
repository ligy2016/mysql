...
/*!50003 CREATE DEFINER=`qlqqmn`@`%` PROCEDURE `prod_get_fuacct_usage`(secacct  VARCHAR(18),OUT ret INT, OUT fuacct VARCHAR(18),OUT useage INT ,OUT usagecode VARCHAR(32))
LABEL_PROC:
BEGIN
