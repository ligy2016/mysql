...
/*Table structure for table `tscorestocksell` */

DROP TABLE IF EXISTS `tscorestocksell`;

CREATE TABLE `tscorestocksell` (
  ...
  `fd_sellprise` decimal(15,4) NOT NULL COMMENT '卖出价格',
